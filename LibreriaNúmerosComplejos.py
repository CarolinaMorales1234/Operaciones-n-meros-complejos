...
def fase(a):
    ...
    Descripción: Funcion encargada de calcular la fase de un numero complejo
    Input: Un arreglo ed la forma [a,b]
    Output: Un valor numerico 
...
def main():
    ...
    if op==1:
        print(sumar(exp1,exp2))
    if op==2:
        print(restar(exp1,exp2))
    if op==3:
        print(multiplicar(exp1,exp2))
    if op==4:
        print(dividir(exp1,exp2))
    if op==5:
        print(modulo(exp1))
    if op==6:
        print(conjugado(exp1))
    if op==7:
        print(polarC(exp1))
    if op==8:
        print(cartesianaP(exp1))
    if op==9:
        print(fase(exp1))
